...
<form action="product_manage_disp.php" method="post">
  ...
  <table class="admin-table">
    <tbody>
      ...
      <?php foreach ($products as $product) : ?>
        <tr>
          <td>
            <input type="radio" name="product" id="pro_id<?= h($product->id); ?>" value="<?= h($product->id); ?>">
          </td>
          <td>
          ...
          <td>
            <label for="pro_id<?= h($product->id); ?>">¥<?= h($product->price) ?></label>
          </td>
          <td>
